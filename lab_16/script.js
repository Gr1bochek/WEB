...
function changeCatAndDog() {
    if(document.getElementById("animal").getAttribute('alt') == "Dog"){
        document.getElementById("animal").setAttribute("src", "img/cat.jpg");
...
//zavd 5
function Zavd5() {
    let header = document.querySelector('#zavd5 > h1');
    ...
    let span = document.querySelector('#zavd5 > span');
...
function createContent(){
    let div = document.getElementById('zavd7');
